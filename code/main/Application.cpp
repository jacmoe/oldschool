...
Application::~Application()
{
    SPDLOG_INFO("Oldschool shutdown.");
}
...
bool Application::init()
{
    ...
    m_config.reset(al_load_config_file("assets/config/oldschool.ini"));
    if (!m_config.get())
    {
...
void Application::render()
{
    ...
    al_draw_text(m_title_font.get(), al_color_name("blanchedalmond"), 10.0, 10.0, 0, "Oldschool");
